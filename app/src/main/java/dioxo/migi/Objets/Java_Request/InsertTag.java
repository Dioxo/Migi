...
public class InsertTag extends StringRequest {
    private static final String route = Constantes.INSERT_TAG;
    private Map<String, String> parametres;

    public InsertTag(Response.Listener<String> listener, String tagNom) {
        ...
        parametres.put("text_tag", tagNom);
